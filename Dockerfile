...
RUN for n in CT14lo CT14nlo MSTW2008lo68cl MSTW2008nlo68cl; do wget http://lhapdfsets.web.cern.ch/lhapdfsets/current/$n.tar.gz && tar xvfz "$n.tar.gz" --directory $LHAPDF/share/LHAPDF/ ; done
